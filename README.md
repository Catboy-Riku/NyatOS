...
Installing it is super easy, just paste the command below into a fresh computer in your Minecraft world,  
...
This will eventually cause an out of memory error if you make too much save data and don't change the default max.
